...
#define ADDITION_ERROR_TEST(ADDITION_FUNCTION, ADDITION_FUNCTION_NAME)          \
...
ADDITION_ERROR_TEST(dml::naive_addition, Naive)
ADDITION_ERROR_TEST(dml::distributed_addition, Distributed)
